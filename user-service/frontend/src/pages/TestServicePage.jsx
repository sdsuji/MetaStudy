...
import './AssignmentsPage'; // Assuming the CSS file is shared
...
const TestsPage = () => {
    ...
    const handleUpdateTest = () => {
        if (!editTarget || !editTitle || !editDueDate) {
            setUploadMsg("⚠️ Title and due date are required.");
            return;
        }
    ...
    const handleCreateTest = async () => {
        if (!title || !questionFile || !dueDate) {
            setUploadMsg("⚠️ Please provide title, question file, and due date.");
            return;
        }
        if (gradingMethod === 'auto' && !solutionFile) {
            setUploadMsg("⚠️ Auto-Grading requires a Solution File.");
            return;
        }
                            ...
                            {tests
                                ...
                                .map((a) => {
                                    ...
                                    if (isGraded) {
                                        ...
                                        studentActionText = "Resubmit/View";
                                        studentActionDisabled = false; 
                                    } else {
                                        studentActionDisabled = false; 
                                    }
                                    ...
                                    return (
                                        <div key={a._id} className="assignment-card">
                                            ...
                                            <p>{a.description}</p>
                                            <p>
                                                Grading: <span style={{ fontWeight: 'bold', color: a.gradingMethod === 'auto' ? 'green' : 'orange' }}>{a.gradingMethod.toUpperCase()}</span>
                                            </p>
                                            <p>
                                                Due:{" "}
                                            ...
                                            <div className="actions">
                                                <button onClick={() => handleView(a._id)}>View Question</button>
                        ...
                        {showEditPopup && editTarget && (
                            <div className="popup">
                                <div>
                                    ...
                                    <p style={{ marginTop: '10px' }}>Grading Method: **{editTarget.gradingMethod.toUpperCase()}**</p>
                                    {uploadMsg && <p className="popup-msg">{uploadMsg}</p>}
                                    <div className="popup-actions">
                        ...
                        {showSubmissionPopup && submissionTarget && (
                            <div className="popup submission-popup">
                                <div>
                                    ...
                                    <p>Due: {submissionTarget.dueDate ? new Date(submissionTarget.dueDate).toLocaleString() : "Not set"}</p>
                                    <p>Grading: {submissionTarget.gradingMethod.toUpperCase()}</p>
                                    ...
                                    {(() => {
                                        ...
                                        return (
                                            <div className="submission-upload">
                                                {hasSubmission && <p style={{ color: 'orange' }}>A submission already exists. Uploading a new file will overwrite it.</p>}
                                                <input type="file" onChange={(e) => setQuestionFile(e.target.files[0])} />
                                    ...
                                    <div className="submissions-list-student">
                                        <h4 style={{ marginTop: '15px' }}>Your Submission History</h4>
                                                ...
                                                <div key={s._id} className="submission-card-student">
                                                    <div className="submission-info">
                                                        ...
                                                        <p>
                                                            ...
                                                            <span style={{color: s.gradedAt ? 'green' : 'orange', fontWeight: 'bold', marginLeft: '5px'}}>
                        ...
                        {showAllSubmissionsPopup && submissionTarget && (
                            <div className="popup">
                                <div>
                                    ...
                                    <p>Grading Method: {submissionTarget.gradingMethod.toUpperCase()}</p>
